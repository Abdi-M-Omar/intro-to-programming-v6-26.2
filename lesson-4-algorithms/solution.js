...
let temps = [0, 10, 25, 100];
temps.forEach(c => {
    console.log("Q1 convertTemp: ", c, convertTemp(c));
});
// ---------- QUESTION 2 ----------
...
let string = ["HelloWorld", "JavaScript", "", "1234"];
string.forEach(s => {
    console.log("Q2 reverseString: ", s, reverseString(s));
});
...
console.log("Q3 tipCalculator: ", 20, 0.15, tipCalculator(20, 0.15));
...
[0, 1, 2, 3, 4, 5, 10, 13].forEach(n => {
    console.log("Q6 isPrime: ", n, isPrime(n));
});
...
// PUT YOUR CODE HERE
function passed(letter) {
    if (letter === "A" || letter === "B" || letter === "C") return true;
    else return false;
}
console.log("Q10 passed('A'): ", passed("A"));
...
function printClassResult(className, student, scores) {
    ...
    let result = passed(grade) ? "yes" : "no";

    return `${className} - student: ${student}, Average: ${avg}, Grade: ${grade}, passed: ${result}`;
}
console.log("Q11: ", printClassResult("History 101", "Jane Doe", [60, 70, 85, 87]));
// ---------- QUESTION 12 ----------
